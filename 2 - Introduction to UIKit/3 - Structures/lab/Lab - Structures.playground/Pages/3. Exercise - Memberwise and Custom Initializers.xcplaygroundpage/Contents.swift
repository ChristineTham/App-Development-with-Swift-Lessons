...
var favouriteBook = Book(title: "Lord of the Rings", author: "J. R. R. Tolkien", pages: 1000, price: 19.99)
...
struct Height {
    ...
    let inch2Centimeter = 2.54
    
    init(heightInInches : Double) {
        self.heightInInches = heightInInches
        heightInCentimeters = heightInInches * inch2Centimeter
    }
    init(heightInCentimeters : Double) {
        self.heightInCentimeters = heightInCentimeters
        heightInInches = heightInCentimeters / inch2Centimeter
    }
}
/*:
 ...
 */
var myHeight = Height(heightInCentimeters: 172.0)
